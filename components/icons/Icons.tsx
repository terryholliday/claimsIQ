...
export const MicrophoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6v-1.5m-6 7.5a6 6 0 01-6-6v-1.5m12 7.5v-1.5a6 6 0 00-6-6v-1.5a6 6 0 00-6 6v1.5m6 7.5v-1.5" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75a3 3 0 003-3v-3a3 3 0 00-6 0v3a3 3 0 003 3z" /></Icon>
);
...
export const VideoCameraSlashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M12 18.75H4.5a2.25 2.25 0 01-2.25-2.25V9.75A2.25 2.25 0 014.5 7.5h7.5m-1.5 6l-3.375-3.375m3.375 0L10.125 12m3.375 0L10.125 15m3.375 0L15 11.625m-3.375 3.375l3.375 3.375" /></Icon>
);
...
export const DocumentTextIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3h7.5m-7.5-3v-3m0 3h7.5" /></Icon>
);
...
export const CurrencyDollarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.826-1.106-2.156 0-2.982C10.544 8.22 11.27 8 12 8c.768 0 1.536.219 2.148.659l.878.659m0 0v-2.25m0 2.25c-.228.171-.48.312-.75.425a23.455 23.455 0 01-1.254 1.018c-2.07 1.548-4.762 1.548-6.834 0C4.996 11.332 4.001 9.94 4.001 8.25c0-1.69.995-3.082 2.625-3.9-1.63-.818-2.625-2.21-2.625-3.9 0-1.69.995-3.082 2.625-3.9C7.836.88 9.392 0 11.25 0h1.5c1.858 0 3.414.88 4.625 2.25 1.21 1.368 1.875 3.244 1.875 5.25 0 1.933-.589 3.687-1.632 5.053-.873 1.134-2.053 2.01-3.518 2.512z" /></Icon>
);

export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.572L16.5 21.75l-.398-1.178a3.375 3.375 0 00-2.455-2.456L12.75 18l1.178-.398a3.375 3.375 0 002.455-2.456L16.5 14.25l.398 1.178a3.375 3.375 0 002.456 2.456l1.178.398-1.178.398a3.375 3.375 0 00-2.456 2.456z" /></Icon>
);

export const MobilePhoneIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const CheckBadgeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 011.043-3.296 3.746 3.746 0 013.296-1.043A3.746 3.746 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z" /></Icon>
);

export const UserGroupIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.964A3.75 3.75 0 1012 6a3.75 3.75 0 00-3.75 3.75m0 0A3.75 3.75 0 106 13.5a3.75 3.75 0 003.75-3.75m0-3.75A3.75 3.75 0 106 6a3.75 3.75 0 003.75 3.75m0 9.75a9.094 9.094 0 003.742-.479 3 3 0 00-4.682-2.72M12 12.75a3 3 0 100-6 3 3 0 000 6z" /></Icon>
);
...
export const FunnelIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 3c2.755 0 5.455.232 8.083.678.533.09.917.556.917 1.096v1.044a2.25 2.25 0 01-.659 1.591l-5.432 5.432a2.25 2.25 0 00-.659 1.591v2.927a2.25 2.25 0 01-1.244 2.013L9.75 21v-6.568a2.25 2.25 0 00-.659-1.591L3.659 7.409A2.25 2.25 0 013 5.818V4.774c0-.54.384-1.006.917-1.096A48.32 48.32 0 0112 3z" /></Icon>
);
...
export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.157 1.951m9.345-8.334V6.637c0-1.621-1.152-3.026-2.76-3.235A48.455 48.455 0 0011.25 3c-2.115 0-4.198.137-6.24.402-1.608.209-2.76 1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075 1.157.14 1.74.194V21l4.155-4.155" /></Icon>
);
...
export const ReceiptPercentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9 14.25l6-6m4.5-3.493V21.75l-3.75-1.5-3.75 1.5-3.75-1.5-3.75 1.5V4.757c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 011.927-.184 48.208 48.208 0 011.927.184 2.2 2.2 0 011.907 2.185zm-12 3.375h.008v.008H7.5v-.008zM6.75 7.5h.008v.008H6.75V7.5zm0 3.75h.008v.008H6.75V11.25zm0 3.75h.008v.008H6.75V15zm3-7.5h.008v.008H9.75V7.5zm3.375 0H13.5v.008h-.375V7.5zm0 3.75H13.5v.008h-.375V11.25zm0 3.75H13.5v.008h-.375V15zm3-7.5h.008v.008H16.5V7.5zm0 3.75h.008v.008H16.5V11.25zm0 3.75h.008v.008H16.5V15z" /></Icon>
);
...
export const PaperClipIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M18.375 12.739l-7.693 7.693a4.5 4.5 0 01-6.364-6.364l10.94-10.94A3 3 0 1119.5 7.372L8.552 18.32m.009-.01l-.01.01m5.699-9.941l-7.81 7.81a1.5 1.5 0 002.112 2.13" /></Icon>
);
...
export const ScaleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.031.352 5.988 5.988 0 01-2.031-.352c-.483-.174-.711-.703-.59-1.202L18.75 4.971zm-16.5.52c.99-.203 1.99-.377 3-.52m0 0l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.989 5.989 0 01-2.031.352 5.989 5.989 0 01-2.031-.352c-.483-.174-.711-.703-.59-1.202L5.25 4.971z" /></Icon>
);
...
export const DocumentMagnifyingGlassIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.75l-2.489-2.489m0 0a3.375 3.375 0 10-4.773-4.773 3.375 3.375 0 004.774 4.774zM21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></Icon>
);

export const FlagIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3 3v1.5M3 21v-6m0 0l2.77-.693a9 9 0 016.208.068l.223.057a9.6 9.6 0 005.323.429l2.153-.453.795 2.647a.25.25 0 01-.24.324H17.25a.75.75 0 00-.53.22l-2.22 2.22a.75.75 0 01-.53.22h-4.5" /></Icon>
);
...
export const LightBulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a2.311 2.311 0 01-3.75 0M12 3.75v.007A.75.75 0 0112.75 4.5h.007a.75.75 0 01.75.75v.007A.75.75 0 0113.5 6h.007a.75.75 0 01.75.75v.007A.75.75 0 0115 7.5h.007a.75.75 0 01.75.75v.007A4.5 4.5 0 0119.5 12h.007a4.5 4.5 0 01-4.5 4.5h-.007a4.5 4.5 0 01-4.5-4.5h-.007A4.5 4.5 0 016 12h.007a4.5 4.5 0 014.5-4.5h.007A.75.75 0 0111.25 6h.007a.75.75 0 01.75-.75v-.007A.75.75 0 0112 4.5h.007a.75.75 0 01.75-.75v-.007z" /></Icon>
);
export const BuildingLibraryIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z" /></Icon>
);
export const AcademicCapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-2.072-2.072a50.57 50.57 0 012.658-.813m15.482 0l2.072-2.072a50.57 50.57 0 00-2.658-.813" /></Icon>
);
export const CloudIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-2.43-2.43A3.75 3.75 0 0012 6c-1.492 0-2.834.67-3.75 1.745-1.127-.22-2.29-.44-3.484-.636A49.034 49.034 0 002.25 15z" /></Icon>
);
...
export const CpuChipIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5m0 15v-1.5M12 8.25v7.5M15.75 15.75v-1.5" /><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75h16.5v16.5h-16.5z" /></Icon>
);
...
export const CubeTransparentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M14.25 7.756a4.5 4.5 0 01-8.5 0 4.5 4.5 0 018.5 0zM10.5 3v.75m0 0l-1.11 4.995a1.5 1.5 0 001.07 1.858l4.995 1.11.75 3.375m-3.75-5.25l.75 3.375m0 0l-1.11 4.995a1.5 1.5 0 01-1.07 1.858l-4.995 1.11m0 0v.75m3.75-5.25l-.75 3.375m0 0l-4.995-1.11a1.5 1.5 0 01-1.07-1.858L5.25 3.75v-.75m3.75 5.25l-3.75-5.25m9 9l-3.75-5.25m0 0l3.75-5.25m-9 9v.75" /></Icon>
);
export const ShieldExclamationIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m0-10.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.75c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.57-.598-3.75h-.152c-3.196 0-6.1-1.248-8.25-3.286zm0 13.036h.008v.008h-.008v-.008z" /></Icon>
);
...
export const QueueListIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" /></Icon>
);
export const QrCodeIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M5.25 8.25h13.5m-13.5 7.5h13.5m-1.5-11.25l.375-.375a1.875 1.875 0 012.652 0l.375.375a1.875 1.875 0 010 2.652l-.375.375m-1.875-2.25l1.5-1.5m-1.5 1.5l-1.5-1.5m1.5 1.5l1.5 1.5m-1.5-1.5l-1.5 1.5m6.375-3.375l.375-.375a1.875 1.875 0 012.652 0l.375.375a1.875 1.875 0 010 2.652l-.375.375m-1.875-2.25l1.5-1.5m-1.5 1.5l-1.5-1.5m1.5 1.5l1.5 1.5m-1.5-1.5l-1.5 1.5m-6.375-3.375l.375-.375a1.875 1.875 0 012.652 0l.375.375a1.875 1.875 0 010 2.652l-.375.375m-1.875-2.25l1.5-1.5m-1.5 1.5l-1.5-1.5m1.5 1.5l1.5 1.5m-1.5-1.5l-1.5 1.5" /></Icon>
);
...
export const TableCellsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5M3.75 21V3" /></Icon>
);
export const PrinterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0110.56 0m-10.56 0L6 18.25m0 0a2.25 2.25 0 002.25 2.25h5.25a2.25 2.25 0 002.25-2.25M6 18.25h12M18.75 16.023V15.75a3.375 3.375 0 00-3.375-3.375h-1.5a1.125 1.125 0 01-1.125-1.125v-1.5A3.375 3.375 0 0012 6.375h-1.5a3.375 3.375 0 00-3.375 3.375V15.75m6.75 0v3.375m0 0h3.375a2.25 2.25 0 002.25-2.25V16.023M3.75 16.023V15.75a3.375 3.375 0 00-3.375-3.375h-1.5a1.125 1.125 0 01-1.125-1.125v-1.5A3.375 3.375 0 003 6.375h1.5a3.375 3.375 0 003.375 3.375V15.75m-6.75 0v3.375m0 0h3.375a2.25 2.25 0 002.25-2.25V16.023" /></Icon>
);
export const FingerPrintIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0119.5 10.5c0 2.92-.556 5.709-1.588 8.261M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75h.008v.008H12v-.008z" /></Icon>
);
...
export const ListBulletIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.007v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 5.25h.007v.008H3.75v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" /></Icon>
);
export const ChatBubbleBottomCenterTextIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.401m-1.44-4.825a2.25 2.25 0 00-2.223 2.223c0 .529.22 1.023.581 1.374l.36.36m-2.223-2.223a2.25 2.25 0 00-2.223 2.223c0 .529.22 1.023.581 1.374l.36.36M3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25z" /></Icon>
);
...
export const TrophyIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9a9.75 9.75 0 001.5-3.75h6a9.75 9.75 0 001.5 3.75zM16.5 18.75a9.75 9.75 0 00-9 0" /><path strokeLinecap="round" strokeLinejoin="round" d="M12 15V9" /><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 9.75c0 1.933-1.567 3.5-3.5 3.5s-3.5-1.567-3.5-3.5 1.567-3.5 3.5-3.5 3.5 1.567 3.5 3.5z" /></Icon>
);
...
export const ServerStackIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M6 6.878V6a2.25 2.25 0 012.25-2.25h7.5A2.25 2.25 0 0118 6v.878m-12 0c.235-.083.487-.158.75-.232m10.5 0c.263.074.515.149.75.232m-12 0v9.566c0 .53.43.966 1.026.858l4.5-.838m-5.526 0l4.5 .838m0 0c.29.053.59.082.9.098m8.25-10.5v9.566c0 .53-.43.966-1.026.858l-4.5-.838m5.526 0l-4.5 .838m0 0c-.29.053-.59.082-.9.098" /></Icon>
);
export const MapIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.503-6.912l-3 1.5-3-1.5-3 1.5-3-1.5M21 12l-3-1.5m-3.75 1.5l-3-1.5m3.75 1.5l-3-1.5M3 12l3-1.5" /></Icon>
);
...
export const WrenchScrewdriverIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M11.25 21.75l-2.25-2.25m0 0l2.25-2.25m-2.25 2.25h12.75M16.5 16.5v-2.25m0 0l2.25-2.25m-2.25 2.25l-2.25-2.25m6.75-6.75l-2.25-2.25m0 0l2.25-2.25m-2.25 2.25L12 3.75 9.75 6m0 0l2.25 2.25m0 0l2.25 2.25M9.75 6l-2.25 2.25m2.25-2.25L7.5 3.75 5.25 6m0 0l2.25 2.25m2.25-2.25l-2.25 2.25" /></Icon>
);
export const BuildingStorefrontIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 21V12m0 0H9m3 0h3m-3 0v9M3 6.375c0-1.036.84-1.875 1.875-1.875h14.25c1.035 0 1.875.84 1.875 1.875V12M3 12h18M3 12v6.375c0 1.035.84 1.875 1.875 1.875h14.25A1.875 1.875 0 0021 18.375V12" /></Icon>
);

export const ShoppingBagIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" /></Icon>
);

export const TruckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <Icon {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" /></Icon>
);
