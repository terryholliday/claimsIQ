    ...
    <div className="space-y-8 relative">
      ...
      <div className="flex flex-wrap gap-2 mb-2">
        <button
          ...
          className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${statusFilter === 'All' ? 'bg-neutral-dark text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'}`}
        >
          All Manifests
        </button>
        <button
        ...
        <button
          ...
          className={`px-3 py-1 rounded-full text-sm font-medium transition-colors flex items-center gap-2 ${statusFilter === ClaimStatus.READY_TO_SYNC ? 'bg-green-600 text-white' : 'bg-green-50 text-green-700 hover:bg-green-100'}`}
        >
                        ...
                        <div className="flex flex-col gap-1">
                          ...
                          {claim.preLossMetadata && (
                            <div className="text-[10px] text-gray-400 font-medium">
                              {claim.preLossMetadata.preLossItemCount} items · Vault verified
                            </div>
                          )}
                        </div>
                      </td>
